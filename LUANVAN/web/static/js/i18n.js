...
if (!window.VVi18n) {
    ...
    const EN = {
        ...
        'price.tab.plans':        'Plans',
        'price.tab.history':      'History',
        'price.carousel.hint':    'Swipe to see more plans',
        'price.pill.voices':      'Vietnamese voices',
        'price.pill.emotional':   'Emotional TTS',
        'price.pill.qr':          'Instant QR',
        'price.pill.auto':        'Auto activation',
        'price.step1.title':      'Choose a plan',
        'price.step1.desc':       'Click Subscribe on your preferred plan',
        'price.step2.title':      'Scan QR',
        'price.step2.desc':       'Pay via your banking app',
        'price.step3.title':      'Start using',
        'price.step3.desc':       'Characters added automatically',
        'price.history.intro':    'Track transactions and download invoices.',
        'price.payment.howto':    'How to pay?',
        'price.payment.title':    'Easy Payment',
        'price.payment.qr':       'Scan QR Code',
        'price.payment.transfer': 'Bank Transfer',
        'price.payment.bullet1':  'Select a plan → scan QR on the payment confirmation page',
        'price.payment.bullet2':  'Plan activates automatically after successful transfer',
        'price.payment.bullet3_prefix': 'Contact',
        'price.payment.bullet3_suffix': 'if you need support',
        ...
        // ── Contact page ──
        'contact.page_title':     'Contact Us - VietVoice',
        'contact.kicker':         '24/7 Support',
        'contact.chip.pricing':   'Pricing',
        'contact.stat.response':  'Response',
        'contact.stat.support':   'Support',
        'contact.stat.satisfaction': 'Satisfaction',
        ...
        'prof.cover.change':      'Change cover',
        'prof.cover.remove':      'Remove cover',
        'prof.cover.uploading':   'Uploading cover...',
        'prof.cover.success':     'Cover photo updated',
        'prof.cover.removed':     'Cover removed',
        'prof.cover.err_type':    'Only JPG, PNG or WEBP allowed',
        'prof.cover.err_size':    'Cover must be 3MB or smaller',
        ...
        'prof.plan.used':         'Used',
        'prof.plan.empty_hint':   'No characters used yet',
        ...
        'admin.user.delete_pending': 'Pending deletion',
        'admin.user.joined': 'Joined',
        'admin.user.from': 'From',
        'admin.user.days_left': '{n} days left',
        'admin.user.remaining_short': 'remaining',
        'admin.user.of_limit': 'of limit',
        'admin.user.manage_quota': 'Manage quota',
        'admin.user.extend_plan': 'Extend & plan',
        'admin.user.days': 'days',
        'admin.user.expired': 'Expired',
    ...
    const VI = {
        ...
        'lib.filter.all_voices':  'Tất cả giọng',
        'lib.filter.from':        'Từ',
        'lib.filter.to':          'Đến',
        ...
        'price.tab.plans':        'Gói dịch vụ',
        'price.tab.history':      'Lịch sử',
        'price.carousel.hint':    'Vuốt để xem thêm gói',
        'price.pill.voices':      'Giọng VN',
        'price.pill.emotional':   'Emotional TTS',
        'price.pill.qr':          'QR tức thì',
        'price.pill.auto':        'Tự kích hoạt',
        'price.step1.title':      'Chọn gói',
        'price.step1.desc':       'Nhấn Đăng ký trên gói phù hợp',
        'price.step2.title':      'Quét QR',
        'price.step2.desc':       'Chuyển khoản qua app ngân hàng',
        'price.step3.title':      'Dùng ngay',
        'price.step3.desc':       'Ký tự được cộng tự động',
        'price.history.intro':    'Theo dõi các giao dịch và tải hóa đơn điện tử.',
        'price.payment.howto':    'Cách thanh toán?',
        'price.payment.title':    'Thanh toán dễ dàng',
        'price.payment.qr':       'Quét mã QR',
        'price.payment.transfer': 'Chuyển khoản',
        'price.payment.bullet1':  'Chọn gói → quét QR trên trang xác nhận thanh toán',
        'price.payment.bullet2':  'Gói kích hoạt tự động sau khi chuyển khoản thành công',
        'price.payment.bullet3_prefix': 'Liên hệ',
        'price.payment.bullet3_suffix': 'nếu cần hỗ trợ',
        ...
        'contact.page_title':     'Liên hệ với chúng tôi - VietVoice',
        'contact.kicker':         'Hỗ trợ 24/7',
        'contact.chip.pricing':   'Bảng giá',
        'contact.stat.response':  'Phản hồi',
        'contact.stat.support':   'Hỗ trợ',
        'contact.stat.satisfaction': 'Hài lòng',
        'contact.map.title':      'Vị trí văn phòng',
        'contact.title':          'Liên hệ ',
        'contact.title_highlight':'chúng tôi',
        'contact.subtitle':       'Chúng tôi luôn sẵn sàng hỗ trợ bạn. Gửi câu hỏi, phản hồi hoặc yêu cầu kỹ thuật — đội ngũ VietVoice sẽ phản hồi nhanh nhất có thể.',
        ...
        'prof.cover.change':      'Đổi ảnh bìa',
        'prof.cover.remove':      'Xóa bìa',
        'prof.cover.uploading':   'Đang tải ảnh bìa...',
        'prof.cover.success':     'Cập nhật ảnh bìa thành công',
        'prof.cover.removed':     'Đã xóa ảnh bìa',
        'prof.cover.err_type':    'Chỉ chấp nhận JPG, PNG hoặc WEBP',
        'prof.cover.err_size':    'Ảnh bìa tối đa 3MB',
        ...
        'prof.plan.empty_hint':   'Chưa sử dụng ký tự',
        ...
        'admin.user.status.inactive': 'Vô hiệu',
        'admin.user.delete_pending': 'Chờ xóa',
        'admin.user.joined': 'Tham gia',
        'admin.user.from': 'Từ',
        'admin.user.days_left': 'Còn {n} ngày',
        'admin.user.remaining_short': 'còn lại',
        'admin.user.of_limit': 'hạn mức',
        'admin.user.manage_quota': 'Quản lý hạn mức',
        'admin.user.extend_plan': 'Gia hạn & gói',
        'admin.user.days': 'ngày',
        'admin.user.expired': 'Đã hết hạn',
